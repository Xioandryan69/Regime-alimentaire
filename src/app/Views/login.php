...
<div class="login-page">
  <div class="login-card">
    ...
    <form action="/students" method="get">
      <div class="field-group">
        ...
        <div class="input-wrap">
          ...
          <input type="email" name="email" placeholder="vous@exemple.com" value="<?= esc($defaultEmail) ?>" />
        </div>
      </div>
      ...
      <div class="field-group">
        ...
        <div class="input-wrap">
          ...
          <input type="password" name="password" placeholder="••••••••" value="<?= esc($defaultPassword) ?>" />
        </div>
      </div>
    ...
    <div class="login-footer">
      Acces reserve a l'equipe pedagogique
    </div>
